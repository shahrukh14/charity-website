        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="@if (request()->is('admin/general-settings')) active @endif nav-item">
                <a class="d-flex align-items-center" href="{{ route('admin.general.settings') }}">
                    ...
                    <span class="menu-title text-truncate font-size-12px" data-i18n="General Settings">@lang('General setting')</span>
                </a>
            </li>
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="#">
                    <i data-feather="settings"></i>
                    <span class="menu-title text-truncate" data-i18n="Permission Settings">Permission Settings</span>
                </a>
